...
class CustomItem extends React.Component {
  ...
  editBtn = (e) => {
    console.log("ee", e?.row?.data?.item_ID)
     window.location.href = `/projects/item/edit/${e?.row?.data?.item_ID}`
  }
  viewbtn = () => {
    window.location.href = "/projects/item/edit/62aa1710be609e225d411275=1?isView=true"
    console.log("first")
  }
  handleopen  ()  {
...
<>
      ...
      >
                ...
                <Button  className="btn-Action" onClick={(e) => this.editBtn(e)}><span style={{cursor:"pointer"}} className='btn-Edit'>  <Edit size={25}/></span></Button>
